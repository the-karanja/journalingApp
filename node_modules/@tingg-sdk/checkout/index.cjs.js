...
const dueDate = (value) => {
    ...
    return dayjs__default["default"](value, VALID_DATE_FORMAT, true).utc().isValid();
};
...
const encrypt = ({ ivKey, secretKey, payload }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (error.size !== 0)
            return { error: Object.fromEntries(error), data: null };
        const { createHash, createCipheriv } = yield Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('crypto')); });
...
if (!global.fetch) {
    ...
    // @ts-ignore
    global.Headers = fetch$1.Headers;
    // @ts-ignore
    global.Request = fetch$1.Request;
    // @ts-ignore
...
exports.isUrlResponse = isUrlResponse;
exports.isValidationError = isValidationError;
exports.languageCode = languageCode;
exports.msisdn = msisdn;
exports.noneEmptyString = noneEmptyString;
